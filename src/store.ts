...
function patientToRow(p: Patient) {
  return {
    ...
    pad_items: p.padItems ?? [],
    daily_package_value: p.dailyPackageValue,
    daily_package_shifts: p.dailyPackageShifts,
...
function patientFromRow(r: Record<string, unknown>): Patient {
  return {
    ...
    responsibles: (r.responsibles ?? []) as Patient['responsibles'],
    ...
    padItems: (r.pad_items ?? []) as Patient['padItems'],
    dailyPackageValue: r.daily_package_value != null ? Number(r.daily_package_value) : undefined,
    dailyPackageShifts: r.daily_package_shifts != null ? Number(r.daily_package_shifts) : undefined,
    anamnesis: (r.anamnesis as any) || undefined,
...
export const useHomeCareStore = create<HomeCareState>((set, get) => ({
  ...
  init: async () => {
    ...
    try {
      ...
      const tenants: Tenant[] = (tenantsRes.data ?? []).map((r) => ({
        ...
        companyWebsite: (r.company_website as string) || undefined,
        companyAddress: (r.company_address as string) || undefined,
        companyAddressNumber: (r.company_address_number as string) || undefined,
        companyAddressComplement: (r.company_address_complement as string) || undefined,
        companyNeighborhood: (r.company_neighborhood as string) || undefined,
        companyCity: (r.company_city as string) || undefined,
        companyState: (r.company_state as string) || undefined,
        companyZipCode: (r.company_zip_code as string) || undefined,
      }));
  ...
  addTenant: (tenant) => {
    ...
    upsertRow('tenants', {
      ...
      primary_color: newTenant.primaryColor || null,
        ...
        company_legal_name: newTenant.companyLegalName || null,
        company_trade_name: newTenant.companyTradeName || null,
        company_email: newTenant.companyEmail || null,
        company_phone: newTenant.companyPhone || null,
        company_website: newTenant.companyWebsite || null,
        company_address: newTenant.companyAddress || null,
        company_address_number: newTenant.companyAddressNumber || null,
        company_address_complement: newTenant.companyAddressComplement || null,
        company_neighborhood: newTenant.companyNeighborhood || null,
        company_city: newTenant.companyCity || null,
        company_state: newTenant.companyState || null,
        company_zip_code: newTenant.companyZipCode || null,
    });
  },
  ...
  updateTenant: (id, updates) => {
    ...
    if (updated) {
      upsertRow('tenants', {
        ...
        company_phone: updated.companyPhone || null,
        company_website: updated.companyWebsite || null,
        company_address: updated.companyAddress || null,
        company_address_number: updated.companyAddressNumber || null,
        company_address_complement: updated.companyAddressComplement || null,
        company_neighborhood: updated.companyNeighborhood || null,
        company_city: updated.companyCity || null,
        company_state: updated.companyState || null,
        company_zip_code: updated.companyZipCode || null,
      });
    }
  },
  ...
  createTenantWithInvite: async (input) => {
    ...
    const tenant: Tenant = {
      ...
      companyLegalName: result.tenant.companyLegalName || undefined,
      companyTradeName: result.tenant.companyTradeName || undefined,
      companyEmail: result.tenant.companyEmail || undefined,
      companyPhone: result.tenant.companyPhone || undefined,
      companyWebsite: result.tenant.companyWebsite || undefined,
      companyAddress: result.tenant.companyAddress || undefined,
      companyAddressNumber: result.tenant.companyAddressNumber || undefined,
      companyAddressComplement: result.tenant.companyAddressComplement || undefined,
      companyNeighborhood: result.tenant.companyNeighborhood || undefined,
      companyCity: result.tenant.companyCity || undefined,
      companyState: result.tenant.companyState || undefined,
      companyZipCode: result.tenant.companyZipCode || undefined,
    };
  ...
  updateAdminTenant: async (id, updates) => {
    ...
    const res = await fetch(`/api/admin/tenants/${id}`, {
      ...
      body: JSON.stringify({
        ...
        companyLegalName: updates.companyLegalName,
        companyTradeName: updates.companyTradeName,
        ...
        companyAddressNumber: updates.companyAddressNumber,
        companyAddressComplement: updates.companyAddressComplement,
        companyNeighborhood: updates.companyNeighborhood,
        companyCity: updates.companyCity,
        companyState: updates.companyState,
        companyZipCode: updates.companyZipCode,
      }),
    });
    const result = await res.json();
    if (!res.ok) {
